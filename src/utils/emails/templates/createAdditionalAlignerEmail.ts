 ...
 */
export const createAdditionalAlignerEmailSubject = (doc: Request): string => {
  ...
  return `Nova Solicitação de Alinhador Adicional: ${patientName} (Dr(a). ${customerName})`
}

export const createAdditionalAlignerEmailHTML = (doc: AdditionalAligner) => {
  ...
  return `
    ...
    <head>
      <meta charset="UTF-8">
      <title>Nova Solicitação de Alinhador Adicional</title>
    </head>
    <body style="${styles.body}">
      <div style="${styles.container}">
        <div style="${styles.header}">
          <h1 style="${styles.headerTitle}">Nova Solicitação de Alinhador Adicional</h1>
        </div>
