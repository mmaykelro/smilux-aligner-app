 ...
 */
export const createRequestEmailHTML = (doc: PopulatedRequest) => {
  ...
  return `
    ...
    <head>
      <meta charset="UTF-8">
      <title>Nova Solicitação de Tratamento</title>
    </head>
 ...
 */
export const createEmailSubject = (doc: PopulatedRequest): string => {
  ...
  return `Nova Solicitação de Tratamento: ${patientName} (Dr(a). ${customerName})`
}
